...
function animate() {
  ...
  tl.addLabel('frame_4', 9.5)
    ...
    .to(['#h4', '#phn', '#manageBtn'], 0.5, { autoAlpha: 1, ease: Power2.easeOut }, "frame_4+=0.5")
    .to(["#manageBtn .btn_overlay"], 0.1, { autoAlpha: 1, ease: Power2.easeOut }, "frame_4")
    .to(["#manageBtn"], 0.25, { scale: 0.95, ease: Power2.easeOut }, "frame_4+=1")
    .to(["#manageBtn .btn_overlay"], 0.25, { scale: 1, ease: Power2.easeOut }, "frame_4+=1")
    .to(["#manageBtn"], 0, { scale: 1, ease: Power2.easeOut }, "frame_4+=1.25")
    .to(["#manageBtn .btn_overlay"], 0, { autoAlpha: 0, ease: Power2.easeOut }, "frame_4+=1.25")
